                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="name"
                                                placeholder="Nhập tên danh mục mới" value="{{$menu->name}}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="parent_id" class="form-control">
                                                ...
                                                @if (!empty($listMenu))
                                                    {{loadOptions($listMenu, 0, '', $menu->parent_id)}}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="link"
                                                 placeholder="Đường dẫn tĩnh" value="{{$menu->link}}">
                                            <span style="color:red;" class="errors"></span>
                                        </div>
                                    </div>
                                </div>
